-- Q # 1: Write a query which fetches and displays all the students who have an email id.
...
-- Q # 3:Write a query which will retrieve the registration number, student name,
...
-- Q # 4:Write a query to display the student name, registration number, subject code,subject name,
...
-- Q # 5:Write a query to display the registration number and GPA of each student in
...
-- Q # 6:Write a query to display registration number, student name, the marks of the students,
...
-- Q # 7:Write a query to display all the students whose name starts with “M”.
select student_name from student_info where student_name like 'm%';

-- Q # 8:Write a query which retrieves the student name, registration number and
...
-- Q # 9:Write a query which retrieves student name, registration number and student marks
...
-- Q # 10:Write a query which retrieves student name, registration number and student marks
...
-- Q # 11:Write a query which retrieves student name, registration number and marks of those
...
-- Q # 12:Write a query which retrieves all the students whose name ends with “on”.
